...
> This file is the index of all memory files in `.ai/memory/`.
> **Start every session by reading `.ai/README.md` first.**
...
|-------------------|--------------|
| Any tenant-scoped work | `tenancy-map.md` + `.ai/rules/tenancy-rules.md` |
| Adding a new module | `modules-map.md` + `.ai/rules/module-rules.md` |
...
| SmartTimetable work | `.ai/lessons/known-issues.md` (FET solver sections) |
