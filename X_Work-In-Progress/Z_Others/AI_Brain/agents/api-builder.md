...
## Before Building
1. Read `AI_Brain/memory/tenancy-map.md` — Is this a central or tenant API?
2. Read `AI_Brain/memory/modules-map.md` — Which module does this belong to?
3. Read `AI_Brain/templates/api-response.md` — Standard response format
...
- See `AI_Brain/templates/module-controller.md` for template
