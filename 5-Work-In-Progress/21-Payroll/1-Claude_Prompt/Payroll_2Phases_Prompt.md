...
**Purpose:** This is a single consolidated prompt to build the "Feature Specification" & "Database Schema Design" for Payroll module for Prime-AI. Paste this into Claude and work through each phase sequentially. Claude will stop after each phase for your review and confirmation.
