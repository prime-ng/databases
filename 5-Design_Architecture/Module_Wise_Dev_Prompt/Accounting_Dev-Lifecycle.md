# Prime-AI — Development Lifecycle of Accounting
...
KEY RULE:
- Wireframes are NOT required before starting. Instead, you decide screen layouts AFTER Claude generates the database schema.
- Phase 3 (Screen Planning) happens AFTER you see the DDL tables. You decide layout only when you know what data exists.
...
LAST_AUDIT_DATE   = 20th Mar 2026         # Used in: git --since filter (Tier 3)
