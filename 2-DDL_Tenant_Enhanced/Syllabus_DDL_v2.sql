...
-- =====================================================================
  ...
  CREATE TABLE IF NOT EXISTS `slb_topic_level_types` (
    ...
    `homework_release_flag`            TINYINT(1) GENERATED ALWAYS AS ((case when (`can_be_used_for_homework_release` = 1) then `1` else NULL end)) STORED,
    `can_be_used_for_quiz_release`     TINYINT(1) NOT NULL DEFAULT 1
    `quiz_release_flag`                TINYINT(1) GENERATED ALWAYS AS ((case when (`can_be_used_for_quiz_release` = 1) then `1` else NULL end)) STORED,
    `can_be_used_for_quest_release`    TINYINT(1) NOT NULL DEFAULT 1,
    `quest_release_flag`               TINYINT(1) GENERATED ALWAYS AS ((case when (`can_be_used_for_quest_release` = 1) then `1` else NULL end)) STORED,
  ...
  -- =========================================================
  CREATE TABLE IF NOT EXISTS `hpc_curriculum_change_request` (
    `id`              INT UNSIGNED AUTO_INCREMENT PRIMARY KEY,
