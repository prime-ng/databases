...
-- ===========================================================================
  ...
  CREATE TABLE IF NOT EXISTS `sch_employees` (
    ...
    `branch_id`                 INT UNSIGNED DEFAULT NULL          COMMENT 'v4 — FK to branch/location master',
...
-- ===========================================================================
-- Change Log From 15th Jun'2023 onward
-- ===========================================================================
-- Remove from Table : sch_staff_leave_types Filed : created_by
