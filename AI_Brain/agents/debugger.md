...
## Before Debugging
1. Read `AI_Brain/memory/tenancy-map.md` — Check if the bug is tenancy-context related
2. Read `AI_Brain/memory/conventions.md` — Understand expected patterns
...
### Step 5: Document
- Log the bug and fix in `AI_Brain/memory/decisions.md` if it reveals an architectural issue
