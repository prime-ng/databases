...
| **Date** | 2026-06-29 |
| **Status** | Draft (Superseding) |
| **Supersedes** | LIB_FRD_Old_v1.md (v1.0, 2026-06-25) |
| **Prepared By** | Business Analysis — Prime-AI |
| **Reviewed By** | (Pending) |
| **Approved By** | (Pending) |

> **Version 2.0 note:** This edition supersedes the 2026-06-25 draft. All requirement (REQ-), business-rule (BR-), report (RPT-), and enhancement (ENH-) identifiers and all scope denominators (13 REQ / 60 BR / 4 workflows / 6 reports / 15 enhancements) are **preserved unchanged** to protect the downstream gap-analysis contract. Changes are limited to accuracy and testability corrections — see Document Control at the end of this document.
...
| Total P1 (Standard) Requirements | 5 |
| Total P2 (Enhanced) Requirements | 0 |

> **Reconciliation note (v2.0):** P0 = REQ-LIB-001, 002, 003, 004, 005, 006, 009, 010 (8). P1 = REQ-LIB-007, 008, 011, 012, 013 (5). P2 = 0. Total = 13. The v1.0 split (P0=6 / P1=7) was a counting error — REQ-LIB-009 (Fine Calculation Setup) and REQ-LIB-010 (Fine Collection & Waiver) are both Core (P0) per Section 3 and Section 10.1, and were mis-bucketed as P1 in the v1.0 totals. Corrected here. The 13/60/4/6/15 denominators are unchanged.
...
|---------|------|---------|--------|
| 1.0 | 2026-06-25 | Initial draft — synthesized from preliminary requirements (31 screens), Library DDL v7, V2 technical requirement document, and overview architecture document | Business Analysis — Prime-AI |
| 2.0 | 2026-06-29 | **Superseding edition** (supersedes LIB_FRD_Old_v1.md). All REQ-/BR-/RPT-/ENH- identifiers and scope denominators (13 REQ / 60 BR / 4 workflows / 6 reports / 15 enhancements) preserved unchanged — no renumbering. Accuracy correction: Section 10.4 P0/P1 split corrected from 6/7 to 8/5 (REQ-LIB-009 and REQ-LIB-010 are Core/P0 per Sections 3 and 10.1; previously mis-bucketed). Header updated (v2.0, 2026-06-29, prefix lib_, supersedes reference, version note). Confirmed against verified module facts: Library DDL v7 = 48 tables (prefix `lib_`); the design-lesson separations are honored — Book Catalog (REQ-LIB-002) is kept distinct from Book Acquisition & Copy Registration (REQ-LIB-003), and Fine Calculation Setup (REQ-LIB-009) is kept distinct from Fine Collection & Waiver (REQ-LIB-010, where the Librarian-collects / Supervisor-waives permission split is preserved in BR-LIB-048). No business-language jargon introduced. | Business Analysis — Prime-AI |
