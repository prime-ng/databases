#!/bin/bash
# RatingScale (BehaviouralAssessment) Dusk runner.
# Assumes this file sits at prime_testing/tests/Browser/Modules/BehaviouralAssessment/RatingScale/.
...
if $V1; then FC="bha_RatingScaleV1_TestCas"
elif $V2; then FC="bha_RatingScaleV2_TestCas"
else FC="bha_RatingScale"
fi
FF="${FC}${F:+::${F}}"

echo "=== RatingScale Dusk Tests (filter: $FF) ==="
