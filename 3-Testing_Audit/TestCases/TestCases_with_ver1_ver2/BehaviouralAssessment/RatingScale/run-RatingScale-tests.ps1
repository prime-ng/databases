...
#   prime_testing/tests/Browser/Modules/BehaviouralAssessment/RatingScale/
...
if ($Filter) {
    ...
    $duskFilter = "bha_RatingScaleV1_TestCas"
} elseif ($V2Only) {
    $duskFilter = "bha_RatingScaleV2_TestCas"
} else {
    $duskFilter = "bha_RatingScale"
}
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  RatingScale RESULTS:" -ForegroundColor Cyan
