...
#   prime_testing/tests/Browser/Modules/BehaviouralAssessment/Category/
...
if ($Filter) {
    ...
    $duskFilter = "bha_CategoryV1_TestCas"
} elseif ($V2Only) {
    $duskFilter = "bha_CategoryV2_TestCas"
} else {
    $duskFilter = "bha_Category"
}
