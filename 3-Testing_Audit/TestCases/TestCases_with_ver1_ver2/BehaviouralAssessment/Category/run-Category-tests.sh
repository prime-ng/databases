#!/bin/bash
# Category (BehaviouralAssessment) Dusk runner.
# Assumes this file sits at prime_testing/tests/Browser/Modules/BehaviouralAssessment/Category/.
...
if $V1; then FC="bha_CategoryV1_TestCas"
elif $V2; then FC="bha_CategoryV2_TestCas"
else FC="bha_Category"
fi
FF="${FC}${F:+::${F}}"

echo "=== Category Dusk Tests (filter: $FF) ==="
