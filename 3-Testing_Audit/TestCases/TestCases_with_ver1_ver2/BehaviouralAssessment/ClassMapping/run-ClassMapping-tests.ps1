...
#   prime_testing/tests/Browser/Modules/BehaviouralAssessment/ClassMapping/
...
if ($Filter) {
    ...
    $duskFilter = "bha_ClassMappingV1_TestCas"
} elseif ($V2Only) {
    $duskFilter = "bha_ClassMappingV2_TestCas"
} else {
    $duskFilter = "bha_ClassMapping"
}
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  ClassMapping RESULTS:" -ForegroundColor Cyan
