...
#
# Usage:
#   .\run-BillingCycle-tests.ps1 [-Php <path>] [-Filter <name>] [-V1] [-V2]
#
# Prerequisites:
...
$V1Class = "prm_BillingCycleV1_TestCas"
$V2Class = "prm_BillingCycleV2_TestCas"
...
$ProofDir = "tests/Browser/Modules/Prime/Billing/BillingCycle/proof"
New-Item -ItemType Directory -Force -Path $ProofDir | Out-Null
$ProofFile = Join-Path $ProofDir "billing_cycle_dusk_$Ts.log"

# Clean stale screenshots.
$ShotDir = "tests/Browser/Modules/Prime/Billing/BillingCycle/screenshots"
...
if (-not [string]::IsNullOrWhiteSpace($Filter)) {
    ...
    $FilterArg = "--filter=BillingCycle(V1|V2)_TestCas"
}

Write-Host "==================================================================="
Write-Host " Billing Cycle Dusk run"
