#!/usr/bin/env bash
# =============================================================================
# Consolidated Payment (Billing) — Dusk runner (Linux / WSL / macOS)
...
#
# USAGE
#   ./run-ConsolidatedPayment-tests.sh [--php <path>] [--v1-only] [--v2-only] [--filter <method>]
# =============================================================================
set -uo pipefail

PHP_BIN="php"
FILTER=""
V1_CLASS="bil_ConsolidatedPaymentV1_TestCas"
V2_CLASS="bil_ConsolidatedPaymentV2_TestCas"
RUN_V1=1
RUN_V2=1
...
PROOF_DIR="tests/Browser/Modules/Prime/Billing/ConsolidatedPayment/proof"
mkdir -p "$PROOF_DIR"
PROOF_FILE="${PROOF_DIR}/consolidated_payment_run_${TIMESTAMP}.log"

# Clean old screenshots
find "tests/Browser/Modules/Prime/Billing/ConsolidatedPayment/screenshots" -type f -name '*.png' -delete 2>/dev/null || true
