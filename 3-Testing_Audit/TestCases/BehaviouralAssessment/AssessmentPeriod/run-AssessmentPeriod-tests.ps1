...
#   prime_testing/tests/Browser/Modules/BehaviouralAssessment/AssessmentPeriod/
...
if ($Filter) {
    ...
    $duskFilter = "bha_AssessmentPeriodV1_TestCas"
} elseif ($V2Only) {
    $duskFilter = "bha_AssessmentPeriodV2_TestCas"
} else {
    $duskFilter = "bha_AssessmentPeriod"
}
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  AssessmentPeriod RESULTS:" -ForegroundColor Cyan
