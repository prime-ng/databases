#!/usr/bin/env bash
#
# Runner — BehaviouralAssessment / Dashboard Dusk suite (single comprehensive file).
# Class name = bha_Dashboard_TestCas (no V1/V2 split).
#
# Usage:
#   ./run-Dashboard-tests.sh [--php <php-bin>] [--filter <pattern>] [--sync-db]
#
# Prerequisites:
