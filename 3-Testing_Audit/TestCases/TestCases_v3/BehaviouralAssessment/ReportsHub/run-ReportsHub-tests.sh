#!/usr/bin/env bash
#
# Runner — BehaviouralAssessment / ReportsHub Dusk suite (single comprehensive file).
# Class name = bha_ReportsHub_TestCas (no V1/V2 split).
#
# Usage:
#   ./run-ReportsHub-tests.sh [--php <php-bin>] [--filter <pattern>] [--sync-db]
#
# Prerequisites:
