#!/usr/bin/env bash
#
# Runner — BehaviouralAssessment / RatingScale Dusk suite (single comprehensive file).
# Class name = bha_RatingScale_TestCas (no V1/V2 split).
#
# Usage:
#   ./run-RatingScale-tests.sh [--php <php-bin>] [--filter <pattern>] [--sync-db]
#
# Prerequisites:
...
PHP_BIN="php"
FILTER="bha_RatingScale_TestCas"
SYNC_DB=0
