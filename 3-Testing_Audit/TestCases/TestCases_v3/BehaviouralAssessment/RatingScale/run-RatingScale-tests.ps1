...
# Class name = bha_RatingScale_TestCas. Default filter targets that class.
...
if ($Filter) {
    ...
    $duskFilter = "bha_RatingScale_TestCas"
}
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  RESULTS (RatingScale):" -ForegroundColor Cyan
