#!/usr/bin/env bash
#
# Runner — BehaviouralAssessment / Rating (Ratings Grid) Dusk suite (single comprehensive file).
# Class name = bha_Rating_TestCas (no V1/V2 split). Primary target: BUG-BA-001.
#
# Usage:
#   ./run-Rating-tests.sh [--php <php-bin>] [--filter <pattern>] [--sync-db]
#
# Prerequisites:
