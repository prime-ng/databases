...
# Class name = bha_Rating_TestCas. Default filter targets that class. Primary target: BUG-BA-001.
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  RESULTS (Rating):" -ForegroundColor Cyan
