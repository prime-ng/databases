#!/usr/bin/env bash
#
# Runner — BehaviouralAssessment / AuditTrail Dusk suite (single comprehensive file).
# Class name = bha_AuditTrail_TestCas (no V1/V2 split).
#
# Usage:
#   ./run-AuditTrail-tests.sh [--php <php-bin>] [--filter <pattern>] [--sync-db]
#
# Prerequisites:
