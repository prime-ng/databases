...
# Class name = bha_AuditTrail_TestCas. Default filter targets that class.
...
if ($Filter) {
    ...
    $duskFilter = "bha_AuditTrail_TestCas"
}
...
try {
    ...
    if ($totalCount -ne 0) {
        ...
        Write-Host "  RESULTS (AuditTrail):" -ForegroundColor Cyan
