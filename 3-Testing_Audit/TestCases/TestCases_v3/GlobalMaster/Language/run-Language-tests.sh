...
# Intended install path: prime_testing/tests/Browser/Modules/GlobalMaster/Language/
set -euo pipefail

FILTER="glb_Language_TestCas"
SYNC_DB=false
...
echo ""
echo "=== GlobalMaster Language Test Run Complete ==="
