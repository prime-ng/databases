...
#
# Usage:
#   ./run-Dropdown-tests.sh [--php /path/to/php] [--filter test_dropdown_30] [--sync-db]
...
mkdir -p "$PROOF_DIR"
PROOF_FILE="$PROOF_DIR/dropdown_${TS}.log"

echo "== GlobalMaster Dropdown Dusk run =="
...
SHOT_DIR="$RUNNER_ROOT/tests/Browser/Modules/GlobalMaster/Dropdown/screenshots"
if [[ -d "$SHOT_DIR" ]]; then
