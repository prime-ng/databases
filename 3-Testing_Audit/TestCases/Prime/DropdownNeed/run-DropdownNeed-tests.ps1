<#
=============================================================================
 DropdownNeed (Prime / PRM - CENTRAL) Dusk test runner (Windows PowerShell)
...
$TestClass = "sys_DropdownNeed_TestCas"
$TestPath  = "tests/Browser/Modules/Prime/DropdownNeed/$TestClass.php"

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
$ProofDir  = Join-Path $ScriptDir "proof"
New-Item -ItemType Directory -Force -Path $ProofDir | Out-Null
$Stamp     = Get-Date -Format "yyyyMMdd_HHmmss"
$ProofFile = Join-Path $ProofDir "dropdownneed_dusk_$Stamp.log"

$ShotDir = "tests/Browser/Modules/Prime/DropdownNeed/screenshots"
if (Test-Path $ShotDir) { Remove-Item "$ShotDir/*.png" -Force -ErrorAction SilentlyContinue }

Write-Host "==============================================================="
Write-Host " DropdownNeed (PRM central) - Dusk suite"
