<#
=============================================================================
 Language (Prime / PRM - CENTRAL) Dusk test runner (Windows PowerShell)
 Single comprehensive suite: glb_Language_TestCas.php
=============================================================================
...
$TestClass = "glb_Language_TestCas"
$TestPath  = "tests/Browser/Modules/Prime/Language/$TestClass.php"

$ScriptDir = Split-Path -Parent $MyInvocation.MyCommand.Definition
$ProofDir  = Join-Path $ScriptDir "proof"
New-Item -ItemType Directory -Force -Path $ProofDir | Out-Null
$Stamp     = Get-Date -Format "yyyyMMdd_HHmmss"
$ProofFile = Join-Path $ProofDir "language_dusk_$Stamp.log"

$ShotDir = "tests/Browser/Modules/Prime/Language/screenshots"
if (Test-Path $ShotDir) { Remove-Item "$ShotDir/*.png" -Force -ErrorAction SilentlyContinue }

Write-Host "==============================================================="
Write-Host " Language (PRM central) - Dusk suite"
