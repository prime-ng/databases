...
### 🆔 DB-01
**Comment:**  
deleted_at is in db table and handled through Model SoftDeletes trait
**Decision:** No change required (DDL mismatch / legacy compatibility).

### 🆔 DB-02, DB-03
**Comment:**  
`created_at` is not required as column
**Decision:** No change required (DDL mismatch / legacy compatibility).

### 🆔 DB-02, DB-03
**Comment:**  
No issue, DDL is for refrence for now
...
### 🆔 RT-02, RT-03, RT-04
**Comment:**  
These are verified and are no real issues
**Decision:** No Changes Required
...
### 🆔 CT-01
**Comment:**  
The commented-out Gate check is a critical security risk.
**Decision:** Changes Required

### 🆔 CT-02, CT-03, CT-04, CT-05
**Comment:**  
No real issue, these are verified and the logic is working fine
**Decision:** No Changes Required
...
### 🆔 MD-01, MD-02, MD-03
**Comment:**  
create_by column is not required, usageLogs relationship is not used
**Decision:** No Changes Required

### 🆔 MD-03
**Comment:**  
No confusion implemented intentionally
**Decision:** No Changes Required
...
**Comment:**  
All handled in controller no service needed
**Decision:** No .Changes Required
...
**Comment:**  
Actual issues. Missing requests and broken enum imports in `VendorRequest` will cause runtime errors.
**Decision:** Changes Required
...
### 🆔 PL-01, PL-02
**Comment:**  
Actual issues. Fixes required in `VendorPolicy` and `VendorController`.
**Decision:** Changes Required
...
### 🆔 SEC-01
**Comment:**  
No Issue, database is secured
**Decision:** No Changes Required

📝 Developer Comment:
### 🆔 SEC-01, SEC-02, SEC-03, SEC-04, SEC-05
**Comment:**  
Actual issues. Gate check is required
**Decision:** Changes Required
