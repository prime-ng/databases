...
### 🆔 DB-01, DB-02, DB-03
**Comment:**  
DDL Redundancy is not followed in actual DB   
**Decision:** No Changes Required

### 🆔 DB-04
**Comment:**  
Handled on code level, through Model 
**Decision:** No Changes Required

### 🆔 DB-04
**Comment:**  
Code implementation uses `sys_users`
**Decision:** No Changes Required (DDL Mismatch) can be ignored
...
### 🆔 RT-01
**Comment:**  
EnsureTenantHasModule intentionally disabled for now 
**Decision:** No Changes Required

### 🆔 RT-02
**Comment:**  
Required template  routes are defined elsewhere 
**Decision:** No Changes Required

### 🆔 RT-03
**Comment:**  
Actual Issue. Need to be tenant.**
...
### 🆔 RT-06
**Comment:**  
No Actual Issue. Working as Intended
**Decision:** No Changes Required
...
### 🆔 CT-01, CT-02
**Comment:**  
Validation is handled in NotificationRequest.php
**Decision:** No Changes Required

### 🆔 CT-03
**Comment:**  
It is done as intended
**Decision:** No Changes Required

### 🆔 CT-04, CT-05
**Comment:**  
Needs Gate Authorization
**Decision:** Changes Required

### 🆔 CT-06
**Comment:**  
This logic is written elsewhere
**Decision:** No Changes Required

### 🆔 CT-07, CT-08, CT-09, CT-10
**Comment:**  
Working as Intended
**Decision:** No Changes Required
...
### 🆔 MD-02, MD-03, MD-04
**Comment:**  
`resolvedRecipients()`, `logs()`, `canBeProcessed()` not required for now
**Decision:** No Changes Required

### 🆔 MD-05
**Comment:**  
Needs Verification
**Decision:** Verify, required changes should be implied
...
### 🆔 SV-01
**Comment:**  
Working as Intended. Others are not implemented on purpose
**Decision:** No Changes Required

### 🆔 SV-02
**Comment:**  
Done on purpose, for backup
**Decision:** No Changes Required
...
### 🆔 PL-01
**Comment:**  
It is a backup file. Nothing concerning. Should not be removed
**Decision:** No Changes Required
...
### 🆔 FR-01
**Comment:**  
They are using Requests files for validation
**Decision:** No Changes Required

### 🆔 FR-02
**Comment:**  
Included in NotificationRequests.php
**Decision:** No Changes Required

### 🆔 FR-03
**Comment:**  
Does not need FormRequest, handled on controller layer
**Decision:** No Changes Required
...
### 🆔 PL-02
**Comment:**  
Should be `tenant.notification.*`
**Decision:** Changes Required

### 🆔 PL-03
**Comment:**  
Actual Issue. Gate Authorization is required
**Decision:** Changes Required

### 🆔 PL-04
**Comment:**  
ChannelMaster, ProviderMaster is checked through NotificationManageController rest need Policy
**Decision:** Changes Required
...
### 🆔 SEC-03 
**Comment:**  
Needs Gate Authorization with prefix tenant.*
**Decision:** Changes Required
...
**Comment:**  
Requires a lookup
**Decision:** Thourogh verifcation required
...
### 🆔 PERF-01
**Comment:**  
`index()` is handling 8+ queries because it is required
**Decision:** No Changes Required

### 🆔 PERF-02
**Comment:**  
Most probably handled separately
**Decision:** Needs a lookup

### 🆔 PERF-03
**Comment:**  
should be paginated for 10-15 entries
**Decision:** Changes Required

### 🆔 PERF-05
**Comment:**  
Working fine as Intended for now
**Decision:** No Changes Required
...
### 🆔 TST-01
**Comment:**  
Tests are not written yet, can be ignored for now
**Decision:** No Changes Required
