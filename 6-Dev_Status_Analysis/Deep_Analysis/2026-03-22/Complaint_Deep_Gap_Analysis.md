...
### 🆔 DB-07
**Comment:**  
type mismatch/wrong FK - there's no FK refrence required or implied on `is_medical_check_required` TINYINT it is boolean column 
**Decision:** No change required (DDL mismatch / legacy compatibility)
...
### 🆔 RT-01
**Comment:**  
The duplicate routes are intentional both function differently
**Decision:** No change required .

### 🆔 RT-03
**Comment:**  
Ignore it this route is not crucial
**Decision:** No change required 

### 🆔 RT-04
**Comment:**  
`complaint.complaints.manage` This route is commented intentionally
**Decision:** No change required 
...
### 🆔 CT-01, CT-02
**Comment:**  
The inline validation is working fine, ignore it
**Decision:** No change required .
...
### 🆔 MD-08, MD-09
**Comment:**  
Intentional, they are working fine, db table has these columns
**Decision:** No change required .
