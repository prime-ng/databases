...
CREATE TABLE IF NOT EXISTS `sch_shift` (
  ...
  `code` VARCHAR(20) NOT NULL,   -- e.g., 'MORNING','AFTERNOON','BLOCK','TERM','GROUP'
  `name` VARCHAR(100) NOT NULL,  -- e.g., 'Morning','Afternoon','Block','Term','Group'
...
CREATE TABLE IF NOT EXISTS `tt_school_timing_profile` (
  ...
  CONSTRAINT `fk_stp_period_set` FOREIGN KEY (`default_period_set_id`) REFERENCES `tt_period_set` (`id`) ON DELETE CASCADE SET NULL,
