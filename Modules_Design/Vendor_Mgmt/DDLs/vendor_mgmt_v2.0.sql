...
-- Need to check whether we need 'vnd_complaints' table or we can use common Complaint Module for this?
...
--     CONSTRAINT `fk_vnd_comp_vendor` FOREIGN KEY (`vendor_id`) REFERENCES `vnd_vendors`(`id`) ON DELETE CASCADE
-- ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
