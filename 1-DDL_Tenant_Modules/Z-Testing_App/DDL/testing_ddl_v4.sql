...
-- Based on: testing_requirement.md + preliminary 2-New_Primedb/pgdatabase/1-Master_DDLs/test_runner_db.sql
-- Created: 2026-06-12
--
-- Notes:
...
--  - Conventions followed: InnoDB, utf8mb4, soft deletes (`deleted_at`), `is_active`, `created_at`/`updated_at`, 
--  - `created_by` FK to `tst_users`, `_json` suffix for JSON columns, FK naming `{entity}_id`.
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS `tst_tabs` (
  ...
  `module_id`     INT UNSIGNED NOT NULL,           -- FK to tst_modules
  `main_menu_id`  INT UNSIGNED NOT NULL,           -- FK to tst_main_menus
  `sub_menu_id`   INT UNSIGNED NULL,               -- FK to tst_sub_menus
