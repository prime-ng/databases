...
--  SECTION 0: CONFIGURATION TABLES
  ...
  CREATE TABLE IF NOT EXISTS `sch_academic_term` (
    ...
    `academic_year_start_date` DATE NOT NULL,                        -- Academic Year Start Date (e.g., '2024-01-01'), Denormalization for easy access
    `academic_year_end_date` DATE NOT NULL,                          -- Academic Year End Date (e.g., '2024-12-31'), Denormalization for easy access
    -- Brij - `total_terms_in_academic_session` should be in `sch_org_academic_sessions_jnt` table but for the ease of use in timetable module we are keeping it here. We can also keep it in both the tables and keep the data sync through trigger.
  ...
  CREATE TABLE IF NOT EXISTS `tt_config` (
    ...
    -- Added academic_term_id in the config table to maintain term wise config. This will help school to maintain different config for different term if school want to change config term wise.
    `academic_term_id` SMALLINT unsigned NOT NULL,         -- FK to sch_academic_term.id (This will help us to maintain different config for different term if school want to change config term wise. If school want to have same config for all term then they can keep same value in all term.)
    ...
    UNIQUE KEY `uq_settings_key` (`academic_term_id`, `key`)  -- addedd academic_term_id in unique key to maintain term wise config.
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  -- Data Seed for tt_config
    ...
    -- (1,'2025_26_1st','total_number_of_period_per_day', 'Total Number of Period per Day', '8', 'NUMBER', 'Total Periods per Day', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (2,'2025_26_1st','default_school_open_days_per_week', 'School Open Days per Week', '6', 'NUMBER', 'School Open Days per Week', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (3,'2025_26_1st','default_school_closed_days_per_week', 'School Closed Days per Week', '1', 'NUMBER', 'School Closed Days per Week', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (4,'2025_26_1st','default_number_of_short_breaks_daily_before_lunch', 'Number of Short Breaks Daily Before Lunch', '1', 'NUMBER', 'Number of Short Breaks Daily Before Lunch', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (5,'2025_26_1st','default_number_of_short_breaks_daily_after_lunch', 'Number of Short Breaks Daily After Lunch', '1', 'NUMBER', 'Number of Short Breaks Daily After Lunch', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (6,'2025_26_1st','default_total_number_of_short_breaks_daily', 'Total Number of Short Breaks Daily', '2', 'NUMBER', 'Total Number of Short Breaks Daily', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (7,'2025_26_1st','default_total_number_of_period_before_lunch', 'Total Number of Periods Before Lunch', '4', 'NUMBER', 'Total Number of Periods Before Lunch', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (8,'2025_26_1st','default_total_number_of_period_after_lunch', 'Total Number of Periods After Lunch', '4', 'NUMBER', 'Total Number of Periods After Lunch', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (9,'2025_26_1st','minimum_student_required_for_class_subgroup', 'Minimum Number of Student Required for Class Subgroup', '10', 'NUMBER', 'Minimum Number of Student Required for Class Subgroup', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (10,'2025_26_1st','maximum_student_required_for_class_subgroup', 'Maximum Number of Student Required for Class Subgroup', '25', 'NUMBER', 'Maximum Number of Student Required for Class Subgroup', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (11,'2025_26_1st','max_weekly_periods_can_be_allocated_to_teacher', 'Maximum No of Periods that can be allocated to Teacher per week', '8', 'NUMBER', 'Maximum No of Periods that can be allocated to Teacher per week', NULL, 0, 1, 1, 1, NULL, NULL, NULL),
    -- (12,'2025_26_1st','min_weekly_periods_can_be_allocated_to_teacher', 'Minimum No of Periods that can be allocated to Teacher per week', '8', 'NUMBER', 'Minimum No of Periods that can be allocated to Teacher per week', NULL, 0, 1, 1, 1, NULL, NULL, NULL);
    -- (13,'2025_26_1st','week_start_day', '1st Day of the Week', 'MONDAY', 'STRING', 'Which day will be consider as 1st Day of the Week', NULL, 0, 1, 1, 1, NULL, NULL, NULL);
    -- (14,'2025_26_1st','week_end_day', 'Last Day of the Week', 'SUNDAY', 'STRING', 'Which day will be consider as Last Day of the Week', NULL, 0, 1, 1, 1, NULL, NULL, NULL);
...
-- -------------------------------------------------
  ...
  CREATE TABLE IF NOT EXISTS `tt_period_config` (
    ...
    `period_order` TINYINT UNSIGNED NOT NULL,         -- Order of the period in the day (e.g., 1, 2, 3, 4, 5, 6, 7, 8)
    `period_type_id` INT UNSIGNED NOT NULL,     -- FK to tt_period_type.id
    `default_duration_minutes` INT UNSIGNED NOT NULL,  -- Default Duration of the Period Type in Minutes (e.g., 30, 45, 60)
    `is_active` TINYINT(1) NOT NULL DEFAULT 1,
    `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `deleted_at` TIMESTAMP NULL DEFAULT NULL,
