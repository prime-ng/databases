...
### 🆔 1
**Comment:**  
This is not implemented yet on intention
**Decision:** No Changes Required

### 🆔 2
**Comment:**  
No issue,  this model is not required anymore
**Decision:** Remove StudentDetail.php
...
### 🆔 1
**Comment:**  
This is no issue StudentController is handling lots of logic
**Decision:** No Changes Required

### 🆔 2
**Comment:**  
These routes commented on intention as backup
**Decision:** No Changes Required
...
### 🆔 1
**Comment:**  
StudentController.bk this is a backup file, no issue here
**Decision:** No Changes Required
...
### 🆔 2
**Comment:**  
Inline request is implemented as intended, no issue here, working fine
**Decision:** No Changes Required

### 🆔 3
**Comment:**  
Only for backup, testing reasons
**Decision:** No Changes Required
...
### 🆔 3
**Comment:**  
This check box should not be here
**Decision:** Remove this checkbox carefully, and make sure nothing else is disturbed, comment out this checkbox chunk of code and handle in controller accordingly, carefully
...
### 🆔 1, 2, 3, 4, 5, 6
**Comment:**  
SoftDeletes trait Should be there
**Decision:** Add SoftDeletes trait to these Models, only this nothing else should be touched 
...
### 🆔 1, 2, 3
**Comment:**  
No issue here, code refinement will be done as needed
**Decision:** No Changes Required
...
### 🆔 1, 2, 3
**Comment:**  
Mostly validation is done in controller itself 
**Decision:** No Changes Required
