...
```ascii
┌──────────────────────────────────────────────────────────────────────────────────────────────────────┐
│ ACCOUNTING > VOUCHERS > CREATE                                        FY: 2026-27 ▼   [Draft ●]      │ ← A. Context bar
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│ [F4 Contra] [F5 Payment] [F6 Receipt] [F7 Journal] [F8 Sales] [F9 Purchase] [Alt+F5 Dr Note] [ ⋯ ]   │ ← B. Voucher type switcher
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  PAYMENT                                                    No. [ PAY-0042 ]   Date [ 29-Aug-2026 ]  │ ← C. Voucher header
│  Ref. No. [ CHQ-884512    ]  Ref. Date [ 28-Aug-2026 ]      Mode: (•) Double Entry ( ) Single Entry  │
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  Dr/Cr │ Particulars (Ledger Account)              │ Cost Centre    │      Debit ₹ │     Credit ₹    │ ← D. Particulars grid
│ ───────┼───────────────────────────────────────────┼────────────────┼──────────────┼─────────────────│
...
│   ▸    │ [ Select ledger…                        ] │ [ —          ▼]│  [        ]  │  [          ]   │
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│                                                             TOTAL   │  1,24,500.00 │   1,24,500.00   │ ← E. Totals bar
│                                                             DIFFERENCE:  ₹ 0.00  ✓ Balanced          │
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  Narration                                                                                           │ ← F. Narration
│  [ Electricity bill for Aug-2026 paid vide cheque 884512 ..................................... ]     │
├──────────────────────────────────────────────────────────────────────────────────────────────────────┤
│  ☐ Optional (Memorandum)   ☐ Post-dated          [Cancel]  [Save as Draft]  [Save & Post (Ctrl+A)]   │ ← G. Flags + action bar
└──────────────────────────────────────────────────────────────────────────────────────────────────────┘
```
