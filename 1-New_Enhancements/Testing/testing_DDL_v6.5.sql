...
-- 3. Added many new Tables in version e.g. `tst_testing_table_list`, `tst_testing_table_field_list`, `tst_common_dropdown_master`
-- 4. Introduce new Coding Format for 'tst_module', 'tst_category', 'tst_main_menu', 'tst_sub_menu', 'tst_tab_screens' 
-- ---------------------------------------------------------------------------------------------------------------
-- MODULE TYPE
-- T_ : TENANT MODULE
-- P_ : PRIME MODULE
...
-- ===============================================================================================================
-- WARNING : There are some strict restrictions on the 3 Tables belonging to this Section (TEST-APP CONFIG)
...
INSERT INTO `tst_testing_table_list` (`id`, `code`, `name`, `description`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`)
 VALUES
  ('1', 'TestCases', 'tst_test_cases', 'List of Test Cases for all the Screens of every Modules', 'admin', 'admin', 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('2', 'TabsScreens', 'tst_tabs_screens', 'List of Tabs & Screens of every Modules', 'admin', 'admin', 'admin', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
CREATE TABLE IF NOT EXISTS `tst_testing_table_field_list` (
    ...
    `updated_at`    TIMESTAMP     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `deleted_at`    TIMESTAMP     NULL,
    UNIQUE KEY `uq_tst_ttfl_code` (`table_id`, `code`),
    UNIQUE KEY `uq_tst_ttfl_name` (`table_id`, `name`),
    CONSTRAINT `fk_tst_ttfl_table_id` FOREIGN KEY (`table_id`) REFERENCES `tst_testing_table_list`(`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- Seeder Data : tst_testing_table_field_list
INSERT INTO `tst_testing_table_field_list` (`id`, `table_id`, `code`, `name`, `description`, `created_at`, `updated_at`, `deleted_at`)
 VALUES
  ('1', '1', 'TestCaseType', 'test_case_type_code', 'Test Case Type Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('2', '1', 'TestMethod', 'test_method_code', 'Test Method Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('3', '1', 'TestTechnology', 'test_technology_code', 'Test Technology Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('4', '1', 'TestLayer', 'test_layer_code', 'Test Layer Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('5', '1', 'TCCreationStatus', 'tc_creation_status', 'Test Case Creation Status Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('6', '1', 'TCRunStatus', 'tc_run_status', 'Test Case Run Status Code', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('7', '2', 'RequirDocStatus', 'requir_doc_status', 'Requirement Document Status', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('8', '2', 'TcListStatus', 'tc_list_status', 'Test Case List Status', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('9', '2', 'DevStatus', 'dev_status', 'Development Status', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  ('10', '2', 'TcCreationStatus', 'tc_creation_status', 'Test Case Creation Status', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
  ('11', '2', 'TestCaseRunStatus', 'test_case_run_status', 'Test Case Run Status', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
CREATE TABLE IF NOT EXISTS `tst_common_dropdown_master` (
    ...
    `table_id`          SMALLINT UNSIGNED  NOT NULL, -- FK to tst_testing_table_list.id
    `column_id`         SMALLINT UNSIGNED  NOT NULL, -- FK to tst_testing_table_field_list.id
    ...
    `updated_at`        TIMESTAMP     DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `deleted_at`        TIMESTAMP     NULL,
    UNIQUE KEY `uq_tst_cdm_tableId_columnId_code` (`table_id`,`column_id`,`code`),
    UNIQUE KEY `uq_tst_cdm_tableId_columnId_displayOrder` (`table_id`,`column_id`,`display_order`),
    CONSTRAINT `fk_tst_cdm_tableId` FOREIGN KEY (`table_id`) REFERENCES `tst_testing_table_list`(`id`) ON DELETE RESTRICT,
    CONSTRAINT `fk_tst_cdm_columnId` FOREIGN KEY (`column_id`) REFERENCES `tst_testing_table_field_list`(`id`) ON DELETE RESTRICT,
    CONSTRAINT `fk_tst_cdm_createdBy` FOREIGN KEY (`created_by`) REFERENCES `tst_users`(`code`),
    CONSTRAINT `fk_tst_cdm_updatedBy` FOREIGN KEY (`updated_by`) REFERENCES `tst_users`(`code`),
    CONSTRAINT `fk_tst_cdm_deletedBy` FOREIGN KEY (`deleted_by`) REFERENCES `tst_users`(`code`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- Seeder Data : tst_common_dropdown_master
INSERT INTO `tst_common_dropdown_master` (`id` `table_id`, `column_id`, `display_order`, `code`, `name`, `description`, `created_by`, `updated_by`, `deleted_by`, `created_at`, `updated_at`, `deleted_at`)
 VALUES
  (1,'1','1',1, 'Standard','Standard', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (2,'1','1',2, 'Unit', 'Unit', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (3,'1','1',3, 'Validation', 'Validation', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (4,'1','1',4, 'Feature', 'Feature', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (5,'1','1',5, 'Business_Condition', 'Business Condition', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (6,'1','2',1, 'Manual', 'Manual', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (7,'1','2',2, 'Automated', 'Automated', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (8,'1','2',3, 'Hybrid', 'Hybrid', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (9,'1','3',1, 'Dusk', 'Dusk', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (10,'1','3',2, 'Laravel-Unit', 'Laravel-Unit', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (11,'1','3',3, 'Native', 'Native', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (12,'1','4',1, 'GUI', 'GUI', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (13,'1','4',2, 'API', 'API', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (14,'1','4',3, 'Unit', 'Unit', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (15,'1','4',4, 'Integration', 'Integration', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (16,'1','4',5, 'Performance', 'Performance', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (17,'1','4',6, 'Security', 'Security', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (18,'1','4',7, 'Accessibility', 'Accessibility', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (19,'1','4',8, 'Other', 'Other', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (20,'1','5',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (21,'1','5',2, 'In-Progress', 'In-Progress', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (22,'1','5',3, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (23,'1','5',4, 'Error', 'Error', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (24,'1','5',5, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (25,'1','5',6, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (26,'1','6',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (27,'1','6',2, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (28,'1','6',3, 'Error', 'Error', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (29,'1','6',4, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (30,'1','6',5, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
  (31,'2','6',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (32,'2','6',2, 'In-Progress', 'In-Progress', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (33,'2','6',3, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (34,'2','6',4, 'In-Complete', 'In-Complete', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (35,'2','6',5, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (36,'2','6',6, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
  (37,'2','7',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (38,'2','7',2, 'In-Progress', 'In-Progress', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (39,'2','7',3, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (40,'2','7',4, 'In-Complete', 'In-Complete', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (41,'2','7',5, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (42,'2','7',6, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
  (43,'2','8',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (44,'2','8',2, 'Under-Development', 'Under-Development', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (45,'2','8',3, 'In-Review', 'In-Review', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (46,'2','8',4, 'Ready-For-Testing', 'Ready-For-Testing', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (47,'2','8',5, 'Testing-InProgress', 'Testing-InProgress', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (48,'2','8',6, 'Testing-Completed', 'Testing-Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (49,'2','8',7, 'Error', 'Error', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (50,'2','8',8, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (51,'2','8',9, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (52,'2','9',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (53,'2','9',2, 'In-Progress', 'In-Progress', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (54,'2','9',3, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (55,'2','9',4, 'Error', 'Error', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (56,'2','9',5, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (57,'2','9',6, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
  (58,'2','10',1, 'Pending', 'Pending', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (59,'2','10',2, 'Completed', 'Completed', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (60,'2','10',3, 'Error', 'Error', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (61,'2','10',4, 'Hold', 'Hold', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL),
  (62,'2','10',5, 'Not-Required', 'Not-Required', 'super', 'super', 'super', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, NULL);
...
CREATE TABLE IF NOT EXISTS `tst_tabs_screens` (
  ...
  `requirements_md_path`  VARCHAR(500) NULL,              -- path to requirements.md for this screen, if any
  `tc_list_md_path`       VARCHAR(500) NULL,              -- path to tc_list.md for this screen, if any
  `requir_doc_status`     MEDIUMINT UNSIGNED NOT NULL DEFAULT 1,  -- FK to tst_common_dropdown_master.id (e.g. 'Pending','In-Progress','Completed', 'Error', 'Hold', 'Not-Required'),
  `tc_list_status`        MEDIUMINT UNSIGNED NOT NULL DEFAULT 1,  -- FK to tst_common_dropdown_master.id (e.g. 'Pending','In-Progress','Completed', 'Error', 'Hold', 'Not-Required'),
  `dev_status`            MEDIUMINT UNSIGNED NOT NULL DEFAULT 1,  -- FK to tst_common_dropdown_master.id (e.g. 'Pending','Under-Development','In-Review','Ready-For-Testing','Testing-InProgress','Testing-Completed', 'Error', 'Hold', 'Not-Required'),
  `tc_creation_status`    MEDIUMINT UNSIGNED NOT NULL DEFAULT 1,  -- FK to tst_common_dropdown_master.id (e.g. 'Pending','In-Progress','Completed', 'Error', 'Hold', 'Not-Required'),
  `test_case_run_status`  MEDIUMINT UNSIGNED NOT NULL DEFAULT 1,  -- FK to tst_common_dropdown_master.id (e.g. 'Pending','In-Progress','Completed', 'Error', 'Hold', 'Not-Required'),
  `is_active`             TINYINT(1) NOT NULL DEFAULT 1,
  `created_by`            VARCHAR(10) NOT NULL,  -- FK to tst_users.code
  `updated_by`            VARCHAR(10) NOT NULL,  -- FK to tst_users.code
  `deleted_by`            VARCHAR(10) NOT NULL,  -- FK to tst_users.code
  ...
  CONSTRAINT `fk_tst_tabs_requirDocStatus` FOREIGN KEY (`requir_doc_status`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_tabs_tcListStatus` FOREIGN KEY (`tc_list_status`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_tabs_devStatus` FOREIGN KEY (`dev_status`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_tabs_tcCreationStatus` FOREIGN KEY (`tc_creation_status`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_tabs_testCaseRunStatus` FOREIGN KEY (`test_case_run_status`) REFERENCES `tst_common_dropdown_master`(`id`),
...
CREATE TABLE IF NOT EXISTS `tst_test_cases` (
  ...
  `test_case_type_id`       MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. Standard, Validation, UI, API, Security, Performance, Accessibility, Other)
  `test_method_id`          MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. Manual, Automated, Hybrid)
  `test_technology_id`      MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. Laravel, Vue, Native, Laravel-Unit, Dusk, Other)
  `test_layer_id`           MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. GUI, API, Unit, Integration, Performance, Security, Accessibility, Other)
  `tc_creation_status`      MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. Pending, In-Progress, Completed, Error, Hold, Not-Required)
  `tc_run_status`           MEDIUMINT UNSIGNED NOT NULL,      -- FK to tst_common_dropdown_master.id (e.g. Pending, In-Progress, Completed, Error, Hold, Not-Required)
  ...
  INDEX `idx_tst_testCases_status` (`tc_creation_status`),
  ...
  CONSTRAINT `fk_tst_testCases_testCaseType` FOREIGN KEY (`test_case_type_id`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_testCases_testingType` FOREIGN KEY (`test_method_id`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_testCases_testingTechnology` FOREIGN KEY (`test_technology_id`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_testCases_testingLayer` FOREIGN KEY (`test_layer_id`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_testCases_tcCreationStatus` FOREIGN KEY (`tc_creation_status`) REFERENCES `tst_common_dropdown_master`(`id`),
  CONSTRAINT `fk_tst_testCases_tcRunStatus` FOREIGN KEY (`tc_run_status`) REFERENCES `tst_common_dropdown_master`(`id`),
...
-- Conditions:
  ...
  -- Example Data for reference only:
    ...
    --tc_run_status : 
    -- Example for getting Next test Case Code:
    --    SELECT COALESCE(MAX(test_case_code), 0) + 1 AS next_code FROM tst_test_cases WHERE user_code = [USER_CODE] AND ts_code = [TS_CODE]
