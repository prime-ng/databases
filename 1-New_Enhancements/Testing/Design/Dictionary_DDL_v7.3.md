...
```
   ...
   ts_code         T0104010200      a screen       — starts with T010401
        ↓
   tcr_code        D02A_T0104010200_001   GENERATED. A PLANNED test  (TcList entry)
...
|---|---|---|
| `D02A_T0104010200_001` | Verify a subject can be assigned to a class | `Released` |
| `D02A_T0104010200_002` | Verify duplicate subject assignment is rejected | `In-Progress` |
| `D02A_T0104010200_003` | Verify assignment is blocked for an inactive class | `Planned` |
| `D02A_T0104010200_004` | Verify the print button renders | `Not-Required` ← reason: *screen is view-only* |
...
| `tcr_code` | VARCHAR(20) | — | **GEN + UK.** `machine_code ‖ '_' ‖ ts_code ‖ '_' ‖ LPAD(tc_list_number, 3, '0')` | `D02A_T0104010200_001` |
