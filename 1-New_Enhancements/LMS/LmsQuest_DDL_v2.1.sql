...
-- Main Quest Table
  CREATE TABLE IF NOT EXISTS `lms_quests` (
    ...
    CONSTRAINT `fk_quest_SchduleId` FOREIGN KEY (`schedule_id`) REFERENCES `slb_syllabus_schedule` (`id`) ON DELETE SET NULL,
  ...
  CREATE TABLE IF NOT EXISTS `lms_quest_scopes` (
    ...
    `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    `deleted_at` TIMESTAMP NULL DEFAULT NULL,LessoLe
    PRIMARY KEY (`id`),
