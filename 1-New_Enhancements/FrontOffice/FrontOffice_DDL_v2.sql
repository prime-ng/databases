...
-- Based on: FOF_FrontOffice_Requirement.md v1
...
-- =============================================================================
-- Main Menu : `Visitor Management`
-- Sub-Menu  : `FrontOffice Masters`
-- =============================================================================

-- Tab : `Visitor Purposes`
-- ----------------------------------------------------------------------------
-- Visitor visit purpose lookup master
...
-- Visitor register (digital replacement for paper visitor book)
...
-- Meeting scheduling with slot conflict check
...
-- Student/staff early exit authorization
...
-- Student mid-day parent pickup (feeds ATT module)
...
-- =============================================================================
-- Main Menu : `Call & Postal Management`
-- Sub-Menu  : `FrontOffice Masters`
-- =============================================================================

-- External emergency contact directory
...
-- Inward/outward mail and courier register
...
-- Official outgoing correspondence log
...
-- =============================================================================
-- Main Menu : `Events & Announcements`
-- Sub-Menu  : `FrontOffice Masters`
-- =============================================================================

-- Digital notice board entries
...
-- Public-facing school calendar events
...
-- Certificate request with multi-stage approval and PDF issuance
...
-- Append-only per-recipient NTF delivery log
...
-- Per-recipient SMS delivery tracking
...
-- =============================================================================
-- Common Features (Standard) - Advance Version of same features are in Modules
-- Complaint Module, Feedback Module, 
-- =============================================================================

-- Front-office lightweight complaint intake
...
-- Feedback form definitions (MCQ/rating/text questions)
