...
### 🆔 DB-01, DB-02
**Comment:**  
DDL does not need these columns
**Decision:** No Changes Required

### 🆔 DB-03
**Comment:**  
`Modules/SyllabusBooks/app/Models/MediaFiles.php` this is completely different from sys_media
**Decision:** No Changes Required

### 🆔 DB-04
**Comment:**  
Done Intentionally, working fine
**Decision:** No Changes Required

### 🆔 DB-05
**Comment:**  
Working fine, no issue here
**Decision:** No Changes Required
...
### 🆔 SEC-03 
**Comment:**  
Two validation working for different purpose as intended
**Decision:** No Changes Required
...
### 🆔 INP-01
**Comment:**  
This validator works for different column, validation is handled through form request
**Decision:** No Changes Required
...
### 🆔 LOG-01
**Comment:**  
yes activityLog() is needed
**Decision:** implement the activity logging but carefully the methods' other logics must not break
...
### 🆔 MDL-01
**Comment:**  
Yes UUID is stored and used
**Decision:** No Changes Required

### 🆔 MDL-02
**Comment:**  
`created_by` is not required as column fillable captured by controller auth() logic
**Decision:** No Changes Required

### 🆔 MDL-03
**Comment:**  
Yes MediaFiles model is different than sys_media 
**Decision:** No Changes Required

### 🆔 MDL-04
**Comment:**  
Intentionally done to prevent duplicacy
**Decision:** No Changes Required
...
### 🆔 SVC-01, SVC-02
**Comment:**  
Working as intended the suggested method is not required
**Decision:** No Changes Required
...
### 🆔 FRQ-01
**Comment:**  
This Validator is different from BookRequest both are required
**Decision:** No Changes Required
...
### 🆔 POL-03
**Comment:**  
Intentionally done to resolve conflict
**Decision:** No Changes Required
