...
CREATE TABLE IF NOT EXISTS `ppt_messages` (
  ...
  CONSTRAINT `fk_ppt_msg_guardian` FOREIGN KEY (`guardian_id`)      REFERENCES `std_guardians` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ppt_msg_student` FOREIGN KEY (`student_id`)       REFERENCES `std_students`  (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ppt_msg_sender` FOREIGN KEY (`sender_user_id`)   REFERENCES `sys_users`     (`id`) ON DELETE RESTRICT,
  CONSTRAINT `fk_ppt_msg_recipient` FOREIGN KEY (`recipient_user_id`) REFERENCES `sys_users`    (`id`) ON DELETE RESTRICT
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
...
CREATE TABLE IF NOT EXISTS `ppt_leave_applications` (
  ...
  CONSTRAINT `fk_ppt_leave_student` FOREIGN KEY (`student_id`)            REFERENCES `std_students` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ppt_leave_guardian` FOREIGN KEY (`guardian_id`)           REFERENCES `std_guardians` (`id`) ON DELETE CASCADE,
  CONSTRAINT `fk_ppt_leave_media` FOREIGN KEY (`supporting_doc_media_id`) REFERENCES `sys_media`  (`id`) ON DELETE SET NULL,
  CONSTRAINT `fk_ppt_leave_reviewer` FOREIGN KEY (`reviewed_by_user_id`)   REFERENCES `sys_users`   (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
