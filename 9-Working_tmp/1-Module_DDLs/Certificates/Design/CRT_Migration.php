 ...
 *   sys_dropdowns.id            → unsignedInteger()      (INT UNSIGNED)
    ...
    public function up(): void
    {
        ...
        Schema::create('crt_student_documents', function (Blueprint $table) {
            ...
            $table->unsignedInteger('document_category_id')
                  ->comment('sys_dropdowns.id — TC, Migration, DOB, Aadhaar, Caste, Disability, Photo, Other');
            ...
            $table->foreign('document_category_id', 'fk_crt_sd_document_category_id')
                  ->references('id')->on('sys_dropdowns')->onDelete('restrict');
