...
--   `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
--   `grading_schema_id` INT UNSIGNED NOT NULL,
...
CREATE TABLE IF NOT EXISTS `lms_exams` (
  ...
  `academic_session_id` INT UNSIGNED NOT NULL, -- FK to glb_academic_sessions
  `exam_type_id` INT UNSIGNED NOT NULL,        -- FK to lms_exam_types (e.g. 'UT-1','UT-2','UT-3','UT-4','HY-EXAM','ANNUAL-EXAM')
...
CREATE TABLE IF NOT EXISTS `lms_paper_set_questions` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `paper_set_id` INT UNSIGNED NOT NULL,        -- FK to lms_exam_paper_sets
...
CREATE TABLE IF NOT EXISTS `lms_exam_student_groups` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `exam_id` INT UNSIGNED NOT NULL,             -- Scope of the group
...
CREATE TABLE IF NOT EXISTS `lms_exam_allocations` (
  ...
  `target_id` INT UNSIGNED NOT NULL,           -- ID of Class, Section, ExamGroup, or Student
...
CREATE TABLE IF NOT EXISTS `lms_student_attempts` (
  ...
  `paper_set_id` INT UNSIGNED NOT NULL,        -- The actual set assigned/taken
  `allocation_id` INT UNSIGNED DEFAULT NULL,   -- Link to allocation rule
