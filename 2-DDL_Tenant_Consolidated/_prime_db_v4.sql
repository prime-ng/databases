...
-- ===============================================================================================================
  ...
  CREATE TABLE IF NOT EXISTS `sys_roles` (
    ...
    UNIQUE KEY `uq_roles_shortName_guardName` (`short_name`,`guard_name`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  -- Ths Table will capture the detail of which Field of Which Table for Which Databse Type, I can create a Dropdown in sys_dropdown_table of?
  -- This will help us to make sure we can only create a Dropdown in sys_dropdown_table whcih has been configured by Developer.
...
-- ===============================================================================================================
  ...
  CREATE TABLE IF NOT EXISTS `prm_module_plan_jnt` (
    ...
    `updated_at` timestamp NULL DEFAULT NULL,
    PRIMARY KEY (`id`),
    CONSTRAINT `fk_modulePlan_moduleId` FOREIGN KEY (`module_id`) REFERENCES `glb_modules` (`id`)  -- Note: glb_modules is a VIEW in prime_db; FK may need to reference global_master.glb_modules directly ON DELETE CASCADE,
  ...
  CREATE TABLE IF NOT EXISTS `prm_tenant_plan_jnt` (
    ...
    `created_at` timestamp NULL DEFAULT NULL,
    `updated_at` timestamp NULL DEFAULT NULL,
    `current_flag` int GENERATED ALWAYS AS ((case when (`is_subscribed` = 1) then `tenant_id` else NULL end)) STORED,
    PRIMARY KEY (`id`),
  ...
  CREATE TABLE IF NOT EXISTS `prm_tenant_plan_rates` (
    ...
    CONSTRAINT `fk_tenantPlanRates_tenantPlanId` FOREIGN KEY (`tenant_plan_id`) REFERENCES `prm_tenant_plan_jnt` (`id`) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  CREATE TABLE IF NOT EXISTS `prm_tenant_plan_module_jnt` (
    ...
    `updated_at` timestamp NULL DEFAULT NULL,
    PRIMARY KEY (`id`),
    CONSTRAINT `fk_moduleTenantPlan_moduleId` FOREIGN KEY (`module_id`) REFERENCES `glb_modules` (`id`)  -- Note: glb_modules is a VIEW in prime_db; FK may need to reference global_master.glb_modules directly ON DELETE RESTRICT,
...
-- ===============================================================================================================
  ...
  CREATE TABLE IF NOT EXISTS `bil_tenant_invoicing_modules_jnt` (
    ...
    UNIQUE KEY `uq_tenantInvModule_invId_moduleId` (`tenant_invoice_id`, `module_id`),
    CONSTRAINT `fk_tenantInvModule_invoiceId` FOREIGN KEY (`tenant_invoice_id`) REFERENCES `bil_tenant_invoices` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_tenantInvModule_moduleId` FOREIGN KEY (`module_id`) REFERENCES `glb_modules` (`id`)  -- Note: glb_modules is a VIEW in prime_db; FK may need to reference global_master.glb_modules directly ON DELETE SET NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  CREATE TABLE IF NOT EXISTS `bil_tenant_invoicing_payments` (
    ...
    `created_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP,
    `updated_at` TIMESTAMP NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
    CONSTRAINT `fk_tenantInvPayment_tenantInvId` FOREIGN KEY (`tenant_invoice_id`) REFERENCES `bil_tenant_invoices` (`id`) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  CREATE TABLE IF NOT EXISTS `bil_tenant_invoicing_audit_logs` (
    ...
    `performed_by` INT UNSIGNED DEFAULT NULL,           -- which user perform the action
    `event_info` JSON DEFAULT NULL,
    `notes` VARCHAR(500) DEFAULT NULL,
    `created_at` TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    CONSTRAINT `fk_audit_billing` FOREIGN KEY (`tenant_invoice_id`) REFERENCES `bil_tenant_invoices` (`id`) ON DELETE CASCADE,
    CONSTRAINT `fk_audit_user` FOREIGN KEY (`performed_by`) REFERENCES `sys_users` (`id`) ON DELETE SET NULL
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
