...
--------------------------------------------------------------------------------------------------------------------
Additional Condition I found during implementation :
1. Multipal Type of Timetable need to be calculated in parralel
2. We need to create Slot availability to identify available slots for every class, Availibility of Teacher & Availability of Rooms just like we have created requirement for Class Group/Sub-Group.
3. Timetable need to Calculate Total registered Student in every Class+Section and store it to sch_class_section_jnt
...
5. tt_activity - it the unit of combination of Class+Section+Subject+Study_Format. This is the main entity which will be assigned a Teacher, Room & Period for all the available week days to generate an specific Timetable.
