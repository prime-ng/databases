...
PHASE 4: ACTIVITY CREATION & PRIORITIZATION
═══════════════════════════════════════════════════════════════════════════════
...
4.2 Activity Prioritization Formula
...
5.3 Algorithm Execution (FET-based recursive swapping)
...
PHASE 6: POST-GENERATION PROCESSING
═══════════════════════════════════════════════════════════════════════════════
...
PHASE 7: SUBSTITUTION MANAGEMENT
═══════════════════════════════════════════════════════════════════════════════
7.1 Absence Recording
    ├── Create tt_teacher_absence record
    └── Mark substitution_required = 1

7.2 Substitution Finder (Real-time)
