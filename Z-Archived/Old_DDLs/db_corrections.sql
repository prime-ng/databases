...
-- ===========================================================================
  ...
  CREATE TABLE IF NOT EXISTS `sys_model_has_permissions_jnt` (
    ...
    -- Note: Polymorphic FK to sys_models removed — table does not exist; polymorphic relations cannot have FK constraints
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ===========================================================================
  ...
  CREATE TABLE IF NOT EXISTS sys_rule_engine_config (
    ...
    updated_at TIMESTAMP NULL DEFAULT NULL,
    deleted_at TIMESTAMP NULL DEFAULT NULL,
    CONSTRAINT fk_rule_trigger FOREIGN KEY (trigger_event_id) REFERENCES sys_trigger_event(id),
  ...
  CREATE TABLE IF NOT EXISTS sys_rule_action_map (
    ...
    created_at TIMESTAMP NULL DEFAULT NULL,
    updated_at TIMESTAMP NULL DEFAULT NULL,
    CONSTRAINT fk_rule_action_rule FOREIGN KEY (rule_id) REFERENCES sys_rule_engine_config(id),
    CONSTRAINT fk_rule_action_action FOREIGN KEY (action_type_id) REFERENCES sys_action_type(id)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
  ...
  CREATE TABLE IF NOT EXISTS sys_rule_execution_log (
    ...
    CONSTRAINT fk_log_rule FOREIGN KEY (rule_id) REFERENCES sys_rule_engine_config(id),
    CONSTRAINT fk_log_trigger FOREIGN KEY (trigger_event_id) REFERENCES sys_trigger_event(id),
    CONSTRAINT fk_log_action FOREIGN KEY (action_type_id) REFERENCES sys_action_type(id)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ===========================================================================
  ...
  -- SLA (Expected Resolution Time & Escalation Time)
    ...
    CONSTRAINT `fk_sla_target_vendor_id` FOREIGN KEY (`target_vendor_id`) REFERENCES `vnd_vendors` (`id`) ON DELETE SET NULL,
...
-- ===========================================================================
    ...
    CONSTRAINT `fk_ntf_device_user` FOREIGN KEY (`user_id`) REFERENCES `sys_users`(`id`)
	) ENGINE = InnoDB DEFAULT CHARSET = utf8mb4;
    ...
    CONSTRAINT `fk_ntf_recipient_user` FOREIGN KEY (`resolved_user_id`) REFERENCES `sys_users`(`id`),
...
-- =========================================================================
  ...
  CREATE TABLE IF NOT EXISTS `tt_teacher_availability_detail` (
    ...
    `is_active` TINYINT(1) NOT NULL DEFAULT 1,
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_ta_teacher_day_period` (`teacher_profile_id`, `day_number`, `period_number`),
  ...
  CREATE TABLE IF NOT EXISTS `tt_priority_config` (
    ...
    PRIMARY KEY (`id`),
    UNIQUE KEY `uq_priority_reqConsId` (`requirement_consolidation_id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ===========================================================================
  ...
  CREATE TABLE IF NOT EXISTS `qns_questions_bank` (
    ...
    -- CONSTRAINT `fk_ques_reviewed_by` removed — column `ques_reviewed_by` is commented out in column definitions
  ...
  CREATE TABLE IF NOT EXISTS `qns_question_usage_log` (
    ...
    CONSTRAINT `fk_qusage_usage_context` FOREIGN KEY (`question_usage_type`) REFERENCES `qns_question_usage_type` (`id`) ON DELETE CASCADE
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
-- ===========================================================================
  ...
  CREATE TABLE IF NOT EXISTS `slb_books` (
    ...
    CONSTRAINT `fk_book_cover_image_media_id` FOREIGN KEY (`cover_image_media_id`) REFERENCES `sys_media` (`id`)
  ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
