...
2. Read `AI_Brain/memory/project-context.md` — Full project context
3. Read `AI_Brain/memory/tenancy-map.md` — Multi-tenancy architecture
4. Read `AI_Brain/memory/modules-map.md` — Module structure
5. Read `AI_Brain/memory/conventions.md` — Coding patterns
...
### 10. Documentation
- [ ] Update `AI_Brain/memory/progress.md`
- [ ] Log any architectural decisions in `AI_Brain/memory/decisions.md`

## Code Templates
- Controller: `AI_Brain/templates/module-controller.md`
- Service: `AI_Brain/templates/module-service.md`
- Migration: `AI_Brain/templates/tenant-migration.md` or `AI_Brain/templates/system-migration.md`
- API Response: `AI_Brain/templates/api-response.md`
