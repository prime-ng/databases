...
CREATE TABLE IF NOT EXISTS `sch_class_group_subject_options_jnt` (
  ...
  `subject_study_format_option_id` INT unsigned NOT NULL,    -- FK to 'sch_subject_options'
  ...
  `subject_studyformat_option_id` int unsigned NOT NULL,           -- FK to 'sch_subject_study_format_jnt'
