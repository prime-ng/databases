# Technical Specification & Requirements: Employee Lifecycle (Separation & Approvals)

This document outlines the detailed requirements, database schemas, validation rules, business logic, and status transition workflows for the **Employee Lifecycle / Separation Approvals** tab.

---

## 1. Tab Overview: Lifecycle Approvals (`employee-lifecycle`)

The **Lifecycle Approvals** tab provides school administrators and HR managers with a unified workspace to track, review, audit, and transition employees through various stages of their employment separation (e.g., Resignation, Termination, Retirement, Contract End, Absconding, or Death).

The primary system entity involved is:
* **Employee Separation** (`sch_employee_separations`): Records active, pending, or completed separation requests and tracking checklists.
