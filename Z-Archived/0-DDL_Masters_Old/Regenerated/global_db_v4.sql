...
CREATE TABLE IF NOT EXISTS `glb_modules` (
  `id`                    INT unsigned NOT NULL AUTO_INCREMENT,
  `parent_id`             INT unsigned DEFAULT NULL,        -- fk to self
  `code`                  varchar(3) NOT NULL,              -- 'std', 'sch', 'lib', 'tim', 'tpt', 'hos', 'acc', etc.
  `name`                  varchar(50) NOT NULL,             -- 'Student Management', 'School Setup', 'Library', 'Timetable', 'Transport', 'Hostel', 'Accounting', etc.
  `version`               tinyint NOT NULL DEFAULT '1',     -- Version of the module e.g. 1, 2
  `is_sub_module`         tinyint(1) NOT NULL DEFAULT '0',  -- kept for CONSTRAINT `chk_isSubModule_parentId`
  `description`           varchar(500) DEFAULT NULL,
  `is_core`               tinyint(1) NOT NULL DEFAULT '0',  -- If Yes, will be considered as must have module & cannot be removed from plans)
...
-- ===============================================================================================================================
-- Change Log After date 2026-06-20
-- ===============================================================================================================================
-- Added New Fields in Table : `glb_modules`; Filed : 'code' VARCHAR(5)
