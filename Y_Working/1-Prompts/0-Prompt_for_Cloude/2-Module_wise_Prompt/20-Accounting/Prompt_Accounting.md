...
## 3. Other Modules which will be connected by Accounting Module:
   - StudentFee Module will be connected to grab Fee Invoice & Fee/Fine payment of Education, Transport, Library Fee & Fines.
   - Transport Module may be connected to fetch Transport Fee & Fine Related Info.
   - Vendor Module will connected to Fetch Vendor Invoice & Payment Related Info.
   - Library Module will be connected for Library Fee (If Applicable) or Late Book Submission Fine
   - Hostel Module will be Connected for Hostal Fee & Fine
   - Mess Module will be Connected for Mess Fee & Fine
