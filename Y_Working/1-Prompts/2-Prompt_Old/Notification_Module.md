# Promt for New Module

I need you to act as a Principal Systems Architect to refine and expand my School ERP **Notification Module**. I am using PHP (Laravel) + MySQL. 
...
I want to create a Common Notification Module for School ERP. This module will be used by all modules of the system. Here are few key Requirement I could thought of:

**Modules Name (we are developing for School ERP)**: 
 - Authentication & Authorization Module
 - User Management Module
 - Role Management Module
 - Designation Management Module
 - Subscription Based Billing Module
 - Role based Access & Permission Management Module 
...
1) Notification can be sent to different type of users e.g. Students, Parents, Teachers, Staff, etc.
2) Notification can be sent to multiple users, Groups, Roles, Designations, class, section, only to students of a Subject or to entire School.
3) Notification can be sent to multiple users at the same time.
4) Nitification can be Application Notification, SMS, Whatsapp Message, Email.
5) Notification can be scheduled to be sent at a later time.
6) Notification will use a Pre-defined Template for Notification Body.
7) User can configur what type of Notification he/she want to receive.

These are few Requirement but you need to add all the features that are required for a Common Notification Module.
...
**YOUR MISSION**:
 - You need to create a **Notification Module** for School ERP.
 - Understand the functional requirements, existing schema, **initial version of schema** and the sample screen design style.  
 - Produce a **fully integrated, production-quality Notification Module Design** that:
...
**DELIVERABLES**:
**DELIVERABLE A — Database DDL:**
  • Provide cleaned, refactored CREATE TABLE statements for **Notification Module** tables with:
...
I want you to deliver all the Deliverables one by one. Start with Deliverable A and then after getting confirmation from me move to Deliverable B, then Deliverable C, then Deliverable D.
