...
CREATE TABLE IF NOT EXISTS `asm_assessments` (
  ...
  `lesson_id` INT UNSIGNED DEFAULT NULL,       -- If assessment is lesson-specific
...
CREATE TABLE IF NOT EXISTS `asm_assignments` (
  ...
  `triggered_by_topic_id` INT UNSIGNED DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `asm_topic_teaching_status` (
  ...
  `marked_complete_by` INT UNSIGNED DEFAULT NULL,
