...
CREATE TABLE IF NOT EXISTS `anl_prerequisite_gaps` (
  ...
  `tenant_id` INT UNSIGNED NOT NULL,
  `student_id` INT UNSIGNED NOT NULL,
  `current_topic_id` INT UNSIGNED NOT NULL,    -- Topic student is struggling with
  `prerequisite_topic_id` INT UNSIGNED NOT NULL, -- The missing foundation
...
CREATE TABLE IF NOT EXISTS `anl_student_recommendations` (
  ...
  -- Context
  `based_on_assessment_id` INT UNSIGNED DEFAULT NULL,
