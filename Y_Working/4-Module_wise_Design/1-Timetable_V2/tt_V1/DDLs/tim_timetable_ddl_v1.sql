...
CREATE TABLE IF NOT EXISTS `tt_period_set_period` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `period_set_id` INT UNSIGNED NOT NULL,       -- FK to tt_period_set.period_set_id
  ...
  `period_type_dropdown_id` INT UNSIGNED NULL, -- FK to (sys_dropdown_table.id) reference for period type (e.g., TEACHING, BREAK, LUNCH)
  `is_deleted` TINYINT(1) NOT NULL DEFAULT 1,
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `tt_class_mode_rule` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `class_id` INT UNSIGNED NOT NULL,                        -- FK to sch_classes.id (external)
  `mode_dropdown_id` INT UNSIGNED NOT NULL,                -- FK to (sys_dropdown_table.id) for Timetable Mode (e.g., NORMAL, HALF_YEARLY)
  ...
  `period_set_id` INT UNSIGNED NOT NULL,                   -- Which period set applies
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
  PRIMARY KEY (`id`),
...
--   `class_id` INT UNSIGNED NOT NULL,       -- sch_classes.id
--   `subject_id` INT UNSIGNED NOT NULL,     -- sch_subjects.id
...
CREATE TABLE  IF NOT EXISTS `tt_class_group_requirement` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `class_group_id` INT UNSIGNED NOT NULL,            -- FK to sch_subject_study_format_class_subj_types_jnt.id
...
CREATE TABLE IF NOT EXISTS `tt_generation_run` (
  `id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  `mode_dropdown_id` INT UNSIGNED NOT NULL,  -- e.g., NORMAL, HALF_YEARLY, TODDLER_NORMAL
  `period_set_id` INT UNSIGNED NOT NULL,
  `session_id` INT UNSIGNED NULL,            -- academic session/year
...
CREATE TABLE `tt_timetable_cell` (
  ...
  `class_group_id` INT UNSIGNED NOT NULL,  -- FK → sch_subject_study_format_class_subj_types_jnt.id
  `room_id` INT UNSIGNED DEFAULT NULL,  -- Room must match rooms_type_id from class_group
  `locked` TINYINT(1) NOT NULL DEFAULT 0,
  `source` ENUM('AUTO','MANUAL','ADJUST') NOT NULL DEFAULT 'AUTO',
  `created_at` TIMESTAMP NULL DEFAULT NULL,
  `updated_at` TIMESTAMP NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `tt_timetable_cell_teacher` (
  `cell_id` INT UNSIGNED NOT NULL,
  `teacher_id` INT UNSIGNED NOT NULL,              -- maps to teachers/users table
  `teacher_role_dropdown_id` INT UNSIGNED NULL,    -- sys_dropdown_table id
...
CREATE TABLE IF NOT EXISTS `tt_constraint` (
  `constraint_id` INT UNSIGNED NOT NULL AUTO_INCREMENT,
