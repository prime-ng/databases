...
-- =====================================================================
-- QUERY ANSWERS: Q1:tt_timetable_type=Links Shift+PeriodSet+DayType | Q2:tt_school_timing_profile=MERGED
-- Q3:SubGroup support=YES,added | Q4:Separate Subject=PERFORMANCE | Q5:duration=consecutive,total=weekly
-- Q6:priority=user,difficulty=algo | Q7:duration=COUNT not minutes | Q8:ENUM not dropdown | Q9:tt_constraint_violation=YES
-- =====================================================================
--
-- List of Tables
-- --------------------------
...
-- Queries
-- ----------------------------
-- Query Answers (from v5.0 "Check -" comments):
-- Q#	Query	Answer
-- Q1	What is tt_timetable_type use?	Links Shift + Period Set + Day Type into reusable templates
-- Q2	What about tt_school_timing_profile?	REMOVED - Merged into tt_timetable_type
-- Q3	Should capture SubGroup requirements?	YES - Added class_subgroup_id column
-- Q4	Why separate Subject/StudyFormat in tt_activity?	PERFORMANCE - Avoids JOINs for filtering
-- Q5	duration_periods vs total_periods?	duration = consecutive slots; total = weekly sum
-- Q6	difficulty_score vs priority?	priority = user-defined; difficulty = algorithm metric
-- Q7	Is duration_periods count or minutes?	COUNT of periods, not minutes
-- Q8	Use dropdown for target_type?	NO - ENUM is faster for validation
-- Q9	Add tt_constraint_violation?	YES - Added to track constraint violations

-- Q1:tt_timetable_type=Links Shift+PeriodSet+DayType | Q2:tt_school_timing_profile=MERGED
-- Q3:SubGroup support=YES,added | Q4:Separate Subject=PERFORMANCE | Q5:duration=consecutive,total=weekly
-- Q6:priority=user,difficulty=algo | Q7:duration=COUNT not minutes | Q8:ENUM not dropdown | Q9:tt_constraint_violation=YES
-- ----------------------------
-- 
