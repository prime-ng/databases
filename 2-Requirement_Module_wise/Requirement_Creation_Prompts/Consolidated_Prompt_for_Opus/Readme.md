...
Focus on WHAT the module should do, not what's broken. Capture the complete functional and non-functional specification.
...
OUTPUT_DIR      = {OUTPUT_REPO}/3-Project_Planning/3-Requirements/Modules/{DATE}
```
