...
-- ----------------------------------------------------------------------------
  ...
  -- When Issue a Book, check max_books_allowed in lib_membership_types master table, If member has exceeded the limit, then the member cannot issue a new book.
  -- 
